...
const songLocalizations: Partial<Record<Locale, Partial<Record<PublicDomainSongSlug, SongLocalization>>>> = {
  tr: {
    "ode-to-joy": { origin: "Ludwig van Beethoven, 9. Senfoni'den melodi, 1824", sourceNote: "Kamu malı beste. Bu, modern bir baskıdan kopyalanmamış, basitleştirilmiş bir TuneUniversal eğitim düzenlemesidir.", practiceTips: ["Çalmadan önce standart perdeye akort edin.", "Düzenli bir 4/4 nabzı koruyun.", "Yavaş başlayın ve her dörtlük notayı eşit tutun."] },
    "amazing-grace": { origin: "Geleneksel ilahi melodisi New Britain, 19. yüzyıl", sourceNote: "Kamu malı ilahi melodisi. Bu sayfa, telif korumalı baskıları çoğaltmadan kendi basitleştirilmiş akor ve nota rehberini kullanır.", practiceTips: ["Ölçü başına üç vuruş sayın.", "Uzun notaların çınlamasına izin verin.", "Ton çok yüksekse akor transpoze aracını deneyin."] },
    greensleeves: { origin: "İngiliz geleneksel melodisi, 16. yüzyıl", sourceNote: "Kamu malı geleneksel melodi. Buradaki nota yazımı TuneUniversal için hazırlanmış kısa bir eğitim indirgemesidir.", practiceTips: ["6/8 içinde iki büyük vuruş hissedin.", "Minör karakteri yumuşak tutun.", "Metronom vurgusu birinci vuruşta olacak şekilde yavaş çalışın."] },
    "frere-jacques": { origin: "Fransız geleneksel kanonu", sourceNote: "Kamu malı geleneksel çocuk kanonu. TuneUniversal nota ve akorlarla basitleştirilmiş bir çalışma sürümü sunar.", practiceTips: ["Isınma olarak kullanın.", "Melodiyi iki enstrümanla kanon şeklinde çalın.", "Tempoyu rahat tutun."] },
    "au-clair-de-la-lune": { origin: "Fransız geleneksel şarkısı, 18. yüzyıl", sourceNote: "Kamu malı geleneksel melodi. Bu, site için hazırlanmış derli toplu bir eğitim düzenlemesidir.", practiceTips: ["Yeni başlayanlar için iyi bir ilk melodi.", "Açık pozisyon akorları kullanın.", "Nota bitişlerinin temiz olmasına dikkat edin."] },
    "sakura-sakura": { origin: "Japon geleneksel melodisi", sourceNote: "Kamu malı geleneksel melodi. TuneUniversal kopyalanmış modern bir partisyon değil, basitleştirilmiş bir çalışma sürümü kullanır.", practiceTips: ["Cümlelemeyi sakin tutun.", "Başlamadan önce referans tonunu kullanın.", "Önce daha yavaş bir BPM deneyin."] },
    "twinkle-twinkle-little-star": { origin: "Geleneksel melodi Ah! vous dirai-je, maman, 18. yüzyıl", sourceNote: "Kamu malı geleneksel melodi. TuneUniversal çocuklar için nota ve akorlarla basitleştirilmiş bir çalışma sürümü sunar.", practiceTips: ["Vuruş başına tek notayla başlayın.", "Çalmadan önce ritmi alkışlayın.", "C, F ve G akorlarını yavaş kullanın."] },
    "mary-had-a-little-lamb": { origin: "Geleneksel çocuk melodisi, 19. yüzyıl", sourceNote: "Kamu malı çocuk melodisi. Bu, TuneUniversal için hazırlanmış basitleştirilmiş bir eğitim düzenlemesidir.", practiceTips: ["Önce 1, 2 ve 3 numaralı parmakları kullanın.", "Ritmi eşit tutun.", "Piyano, blok flüt veya ukulele ile deneyin."] },
    "row-row-row-your-boat": { origin: "Geleneksel kanon, 19. yüzyıl", sourceNote: "Kamu malı geleneksel kanon. TuneUniversal korumalı modern baskıları yayınlamadan kısa ve basitleştirilmiş bir çalışma sürümü kullanır.", practiceTips: ["Çalmadan önce ritmi söyleyin veya mırıldanın.", "İki kişiyle kanon olarak deneyin.", "Metronomu yavaş hızda kullanın."] },
    "london-bridge": { origin: "İngiliz geleneksel çocuk şarkısı", sourceNote: "Kamu malı geleneksel melodi. Notalar ve akorlar basitleştirilmiş bir TuneUniversal öğretim sürümüdür.", practiceTips: ["Melodiyi kısa cümlelerle çalın.", "Önce G ve D akorlarını kullanın.", "Tempoyu neşeli ama sabit tutun."] },
    "hot-cross-buns": { origin: "İngiliz geleneksel çocuk ezgisi", sourceNote: "Kamu malı geleneksel çocuk ezgisi. Bu sayfa yeni başlayanlar için çok kısa ve basitleştirilmiş bir düzenleme kullanır.", practiceTips: ["İlk üç nota için mükemmel.", "Yavaş çalın ve yüksek sesle sayın.", "Her nota temiz olana kadar tekrarlayın."] },
    "baa-baa-black-sheep": { origin: "Geleneksel çocuk tekerlemesi melodisi", sourceNote: "Kamu malı geleneksel çocuk melodisi. TuneUniversal nota ve akorlar için basitleştirilmiş bir öğrenme sayfası sunar.", practiceTips: ["Twinkle Twinkle ile aynı melodi biçimini kullanın.", "Önce alkışlamayı deneyin.", "Akor geçişlerini yavaş tutun."] },
    "old-macdonald-had-a-farm": { origin: "Geleneksel çocuk şarkısı, 19. yüzyıl", sourceNote: "Kamu malı geleneksel çocuk melodisi. TuneUniversal korumalı sözleri yayınlamadan nota ve akorlarla basitleştirilmiş bir eğitim sürümü kullanır.", practiceTips: ["Hafif bir 4/4 nabzı koruyun.", "G'den D'ye geçişi yavaş çalışın.", "Rahat bir hız bulmak için Tap BPM kullanın."] },
    "skip-to-my-lou": { origin: "Amerikan geleneksel oyun şarkısı, 19. yüzyıl", sourceNote: "Kamu malı geleneksel melodi. Bu, TuneUniversal'da yeni başlayanlar için hazırlanmış derli toplu bir çalışma düzenlemesidir.", practiceTips: ["Kısa ve temiz cümleler kullanın.", "Dört sabit vuruş sayın.", "Çalmadan önce ritmi alkışlamayı deneyin."] },
    "the-muffin-man": { origin: "İngiliz geleneksel çocuk şarkısı, 19. yüzyıl", sourceNote: "Kamu malı geleneksel çocuk şarkısı. TuneUniversal yalnızca alıştırma amaçlı basitleştirilmiş nota ve akorlar sunar.", practiceTips: ["Önce yavaş çalın.", "Melodiyi eşit tutun.", "İlk akor hedefleri olarak G ve D'yi alın."] },
    "yankee-doodle": { origin: "Geleneksel Amerikan melodisi, 18. yüzyıl", sourceNote: "Kamu malı geleneksel melodi. Bu sayfa yeni başlayanlar için kendi basitleştirilmiş çalışma sürümünü kullanır.", practiceTips: ["Ölçü başına iki vuruş hissedin.", "Gitarda dönüşümlü mızrap kullanın.", "Sekizlikler hızlanıyorsa metronomu yavaşlatın."] },
    "jingle-bells": { origin: "James Lord Pierpont, 1857", sourceNote: "Kamu malı beste. TuneUniversal modern bir baskının kopyasını değil, basitleştirilmiş bir eğitim rehberi sunar.", practiceTips: ["Tekrarlanan notaları hafif tutun.", "Parlak ama kontrollü bir tempo kullanın.", "A7'den D'ye geçişi yavaş çalışın."] },
    "silent-night": { origin: "Franz Xaver Gruber ve Joseph Mohr, 1818", sourceNote: "Kamu malı Noel ilahisi. Buradaki nota ve akorlar TuneUniversal için hazırlanmış basitleştirilmiş bir eğitim düzenlemesidir.", practiceTips: ["Üç yumuşak vuruş sayın.", "Her cümlenin nefes almasına izin verin.", "Yavaş bir metronom kullanın ve susları acele etmeyin."] },
    "auld-lang-syne": { origin: "Geleneksel İskoç melodisi, 18. yüzyıl", sourceNote: "Kamu malı geleneksel melodi. TuneUniversal kısa ve basitleştirilmiş bir akor ve nota rehberi sunar.", practiceTips: ["Sıcak bir legato hissi kullanın.", "Akor geçişlerini rahat tutun.", "Ton rahatsız edici geliyorsa transpoze edin."] },
    "oh-susanna": { origin: "Stephen Foster, 1848", sourceNote: "Kamu malı melodi. Bu sayfa basitleştirilmiş enstrümantal bir çalışma sürümü içerir ve korumalı baskıları çoğaltmaz.", practiceTips: ["Ritmi zıplayan bir karakterde tutun.", "G ve D akorlarıyla başlayın.", "Cümleyi sabitlemek için metronom vurgusunu kullanın."] },
    alouette: { origin: "Fransız-Kanada geleneksel şarkısı, 19. yüzyıl", sourceNote: "Kamu malı geleneksel melodi. TuneUniversal korumalı sözleri yayınlamadan basitleştirilmiş bir eğitim düzenlemesi kullanır.", practiceTips: ["Küçük cümleler kullanın.", "BPM'yi artırmadan önce yavaş çalışın.", "Gitar, piyano veya ukulele ile deneyin."] },
    "when-the-saints-go-marching-in": { origin: "Geleneksel gospel melodisi, 20. yüzyıl başı", sourceNote: "TuneUniversal için hazırlanmış basitleştirilmiş bir eğitim düzenlemesinde kamu malı geleneksel melodi.", practiceTips: ["Önce swingsiz sabit bir nabız kullanın.", "Melodinin net şekilde şarkı söylemesini sağlayın.", "İfadeyi ancak notalar oturduktan sonra ekleyin."] }
  },
  hi: {
    "ode-to-joy": { origin: "लुडविग वान बेथोवेन, सिम्फनी नं. 9 की धुन, 1824", sourceNote: "सार्वजनिक डोमेन की रचना। यह TuneUniversal का सरल शैक्षिक रूपांतर है, किसी आधुनिक संस्करण की नकल नहीं।", practiceTips: ["बजाने से पहले मानक पिच पर ट्यून करें।", "4/4 की स्थिर लय बनाए रखें।", "धीरे शुरू करें और हर चौथाई स्वर को बराबर रखें।"] },
    "amazing-grace": { origin: "पारंपरिक भजन धुन New Britain, 19वीं सदी", sourceNote: "सार्वजनिक डोमेन की भजन धुन। यह पृष्ठ संरक्षित संस्करणों की नकल किए बिना अपनी सरल कॉर्ड और स्वर मार्गदर्शिका देता है।", practiceTips: ["प्रति ताल तीन मात्राएँ गिनें।", "लंबे स्वरों को गूँजने दें।", "यदि स्वरग्राम बहुत ऊँचा हो तो कॉर्ड ट्रांसपोज़र आज़माएँ।"] },
    greensleeves: { origin: "अंग्रेज़ी पारंपरिक धुन, 16वीं सदी", sourceNote: "सार्वजनिक डोमेन की पारंपरिक धुन। यहाँ दी गई स्वरलिपि TuneUniversal के लिए बनाया गया संक्षिप्त शैक्षिक रूपांतर है।", practiceTips: ["6/8 में दो बड़ी मात्राएँ महसूस करें।", "माइनर रंग को कोमल रखें।", "पहली मात्रा पर मेट्रोनोम के ज़ोर के साथ धीरे अभ्यास करें।"] },
    "frere-jacques": { origin: "फ़्रांसीसी पारंपरिक कैनन", sourceNote: "सार्वजनिक डोमेन का पारंपरिक बाल-कैनन। TuneUniversal स्वर और कॉर्ड के साथ सरल अध्ययन संस्करण देता है।", practiceTips: ["इसे वार्म-अप के रूप में इस्तेमाल करें।", "धुन को दो वाद्यों के साथ कैनन की तरह बजाएँ।", "गति को सहज रखें।"] },
    "au-clair-de-la-lune": { origin: "फ़्रांसीसी पारंपरिक गीत, 18वीं सदी", sourceNote: "सार्वजनिक डोमेन की पारंपरिक धुन। यह साइट के लिए बनाया गया संक्षिप्त शैक्षिक रूपांतर है।", practiceTips: ["शुरुआती लोगों के लिए अच्छी पहली धुन।", "खुली स्थिति वाले कॉर्ड इस्तेमाल करें।", "स्वरों के साफ़ अंत पर ध्यान दें।"] },
    "sakura-sakura": { origin: "जापानी पारंपरिक धुन", sourceNote: "सार्वजनिक डोमेन की पारंपरिक धुन। TuneUniversal नकल की गई आधुनिक स्वरलिपि नहीं, बल्कि सरल अध्ययन संस्करण देता है।", practiceTips: ["वाक्यांशों को शांत रखें।", "शुरू करने से पहले संदर्भ स्वर का उपयोग करें।", "पहले धीमा BPM आज़माएँ।"] },
    "twinkle-twinkle-little-star": { origin: "पारंपरिक धुन Ah! vous dirai-je, maman, 18वीं सदी", sourceNote: "सार्वजनिक डोमेन की पारंपरिक धुन। TuneUniversal बच्चों के लिए स्वर और कॉर्ड सहित सरल अध्ययन संस्करण देता है।", practiceTips: ["प्रति मात्रा एक स्वर से शुरू करें।", "बजाने से पहले ताल पर ताली बजाएँ।", "C, F और G धीरे-धीरे इस्तेमाल करें।"] },
    "mary-had-a-little-lamb": { origin: "पारंपरिक बाल-धुन, 19वीं सदी", sourceNote: "सार्वजनिक डोमेन की बाल-धुन। यह TuneUniversal के लिए बनाया गया सरल शैक्षिक रूपांतर है।", practiceTips: ["पहले 1, 2 और 3 उँगलियों का प्रयोग करें।", "ताल को एकसमान रखें।", "इसे पियानो, बाँसुरी या युकुलेले पर आज़माएँ।"] },
    "row-row-row-your-boat": { origin: "पारंपरिक कैनन, 19वीं सदी", sourceNote: "सार्वजनिक डोमेन का पारंपरिक कैनन। TuneUniversal संरक्षित आधुनिक संस्करण प्रकाशित किए बिना छोटा सरल अध्ययन संस्करण देता है।", practiceTips: ["बजाने से पहले ताल को गाएँ या गुनगुनाएँ।", "इसे दो लोगों के साथ कैनन की तरह आज़माएँ।", "मेट्रोनोम को धीमी गति पर रखें।"] },
    "london-bridge": { origin: "अंग्रेज़ी पारंपरिक बाल-गीत", sourceNote: "सार्वजनिक डोमेन की पारंपरिक धुन। स्वर और कॉर्ड TuneUniversal का सरल शिक्षण संस्करण हैं।", practiceTips: ["धुन को छोटे वाक्यांशों में बजाएँ।", "पहले G और D कॉर्ड इस्तेमाल करें।", "गति को चंचल पर स्थिर रखें।"] },
    "hot-cross-buns": { origin: "अंग्रेज़ी पारंपरिक बाल-धुन", sourceNote: "सार्वजनिक डोमेन की पारंपरिक बाल-धुन। यह पृष्ठ शुरुआती लोगों के लिए बहुत छोटा सरल रूपांतर देता है।", practiceTips: ["पहले तीन स्वरों के लिए आदर्श।", "धीरे बजाएँ और ज़ोर से गिनें।", "हर स्वर साफ़ होने तक दोहराएँ।"] },
    "baa-baa-black-sheep": { origin: "पारंपरिक बाल-कविता की धुन", sourceNote: "सार्वजनिक डोमेन की पारंपरिक बाल-धुन। TuneUniversal स्वर और कॉर्ड सीखने का सरल पृष्ठ देता है।", practiceTips: ["Twinkle Twinkle जैसा ही धुन-आकार इस्तेमाल करें।", "पहले ताली बजाकर देखें।", "कॉर्ड बदलाव धीरे रखें।"] },
    "old-macdonald-had-a-farm": { origin: "पारंपरिक बाल-गीत, 19वीं सदी", sourceNote: "सार्वजनिक डोमेन की पारंपरिक बाल-धुन। TuneUniversal संरक्षित गीत-पंक्तियाँ प्रकाशित किए बिना स्वर और कॉर्ड का सरल शैक्षिक संस्करण देता है।", practiceTips: ["हल्की 4/4 लय बनाए रखें।", "G से D के बदलाव का धीरे अभ्यास करें।", "आरामदायक गति खोजने के लिए Tap BPM का उपयोग करें।"] },
    "skip-to-my-lou": { origin: "अमेरिकी पारंपरिक खेल-गीत, 19वीं सदी", sourceNote: "सार्वजनिक डोमेन की पारंपरिक धुन। यह TuneUniversal पर शुरुआती लोगों के लिए बनाया गया संक्षिप्त अध्ययन रूपांतर है।", practiceTips: ["छोटे, साफ़ वाक्यांश इस्तेमाल करें।", "चार स्थिर मात्राएँ गिनें।", "बजाने से पहले ताल पर ताली बजाकर देखें।"] },
    "the-muffin-man": { origin: "अंग्रेज़ी पारंपरिक बाल-गीत, 19वीं सदी", sourceNote: "सार्वजनिक डोमेन का पारंपरिक बाल-गीत। TuneUniversal केवल अभ्यास के लिए सरल स्वर और कॉर्ड देता है।", practiceTips: ["पहले धीरे बजाएँ।", "धुन को एकसमान रखें।", "पहले कॉर्ड लक्ष्य के रूप में G और D लें।"] },
    "yankee-doodle": { origin: "पारंपरिक अमेरिकी धुन, 18वीं सदी", sourceNote: "सार्वजनिक डोमेन की पारंपरिक धुन। यह पृष्ठ शुरुआती लोगों के लिए अपना सरल अध्ययन संस्करण देता है।", practiceTips: ["प्रति ताल दो मात्राएँ महसूस करें।", "गिटार पर बारी-बारी से मिज़राब चलाएँ।", "यदि अठवाँ स्वर तेज़ हो जाए तो मेट्रोनोम धीमा करें।"] },
    "jingle-bells": { origin: "जेम्स लॉर्ड पियरपोंट, 1857", sourceNote: "सार्वजनिक डोमेन की रचना। TuneUniversal आधुनिक संस्करण की नकल नहीं, बल्कि सरल शैक्षिक मार्गदर्शिका देता है।", practiceTips: ["दोहराए जाने वाले स्वर हल्के रखें।", "चमकदार पर नियंत्रित गति रखें।", "A7 से D के बदलाव का धीरे अभ्यास करें।"] },
    "silent-night": { origin: "फ़्रांत्स ज़ावर ग्रुबर और जोसेफ़ मोर, 1818", sourceNote: "सार्वजनिक डोमेन का क्रिसमस गीत। यहाँ दिए स्वर और कॉर्ड TuneUniversal के लिए बनाया गया सरल शैक्षिक रूपांतर हैं।", practiceTips: ["तीन कोमल मात्राएँ गिनें।", "हर वाक्यांश को साँस लेने दें।", "धीमा मेट्रोनोम रखें और विरामों में जल्दबाज़ी न करें।"] },
    "auld-lang-syne": { origin: "पारंपरिक स्कॉटिश धुन, 18वीं सदी", sourceNote: "सार्वजनिक डोमेन की पारंपरिक धुन। TuneUniversal कॉर्ड और स्वर की छोटी सरल मार्गदर्शिका देता है।", practiceTips: ["गर्म लेगातो भाव रखें।", "कॉर्ड बदलाव सहज रखें।", "स्वरग्राम असुविधाजनक हो तो ट्रांसपोज़ करें।"] },
    "oh-susanna": { origin: "स्टीफ़न फ़ॉस्टर, 1848", sourceNote: "सार्वजनिक डोमेन की धुन। इस पृष्ठ पर सरल वाद्य अध्ययन संस्करण है और संरक्षित संस्करणों की नकल नहीं है।", practiceTips: ["ताल को उछाल भरा रखें।", "G और D कॉर्ड से शुरू करें।", "वाक्यांश स्थिर करने के लिए मेट्रोनोम के ज़ोर का उपयोग करें।"] },
    alouette: { origin: "फ़्रेंच-कनाडाई पारंपरिक गीत, 19वीं सदी", sourceNote: "सार्वजनिक डोमेन की पारंपरिक धुन। TuneUniversal संरक्षित गीत-पंक्तियाँ प्रकाशित किए बिना सरल शैक्षिक रूपांतर देता है।", practiceTips: ["छोटे वाक्यांश इस्तेमाल करें।", "BPM बढ़ाने से पहले धीरे अभ्यास करें।", "इसे गिटार, पियानो या युकुलेले पर आज़माएँ।"] },
    "when-the-saints-go-marching-in": { origin: "पारंपरिक गॉस्पेल धुन, 20वीं सदी की शुरुआत", sourceNote: "TuneUniversal के लिए बनाए गए सरल शैक्षिक रूपांतर में सार्वजनिक डोमेन की पारंपरिक धुन।", practiceTips: ["पहले स्विंग रहित स्थिर लय रखें।", "धुन को स्पष्ट रूप से गाने दें।", "स्वर स्थिर होने के बाद ही भाव जोड़ें।"] }
  },
  pl: {
    "ode-to-joy": { origin: "Ludwig van Beethoven, melodia z IX Symfonii, 1824", sourceNote: "Kompozycja w domenie publicznej. To uproszczone opracowanie edukacyjne TuneUniversal, nieskopiowane z nowoczesnego wydania.", practiceTips: ["Nastrój instrument do standardowej wysokości przed grą.", "Utrzymuj równy puls 4/4.", "Zacznij powoli i graj każdą ćwierćnutę równo."] },
    "amazing-grace": { origin: "Tradycyjna melodia hymnu New Britain, XIX wiek", sourceNote: "Melodia hymnu w domenie publicznej. Strona zawiera własny uproszczony przewodnik po akordach i nutach, bez reprodukcji chronionych wydań.", practiceTips: ["Licz trzy miary w takcie.", "Pozwól długim dźwiękom wybrzmieć.", "Wypróbuj transpozytor akordów, jeśli tonacja jest za wysoka."] },
    greensleeves: { origin: "Angielska melodia tradycyjna, XVI wiek", sourceNote: "Tradycyjna melodia w domenie publicznej. Zapis to krótka redukcja edukacyjna przygotowana dla TuneUniversal.", practiceTips: ["Czuj dwie duże miary w metrum 6/8.", "Zachowaj miękki charakter molowy.", "Ćwicz powoli z akcentem metronomu na pierwszą miarę."] },
    "frere-jacques": { origin: "Francuski kanon tradycyjny", sourceNote: "Tradycyjny kanon dziecięcy w domenie publicznej. TuneUniversal udostępnia uproszczoną wersję do nauki z nutami i akordami.", practiceTips: ["Użyj go jako rozgrzewki.", "Zagraj melodię jako kanon na dwa instrumenty.", "Utrzymuj spokojne tempo."] },
    "au-clair-de-la-lune": { origin: "Francuska pieśń tradycyjna, XVIII wiek", sourceNote: "Tradycyjna melodia w domenie publicznej. To zwięzłe opracowanie edukacyjne przygotowane dla serwisu.", practiceTips: ["Dobra pierwsza melodia dla początkujących.", "Używaj akordów w pozycji otwartej.", "Zwracaj uwagę na czyste zakończenia dźwięków."] },
    "sakura-sakura": { origin: "Japońska melodia tradycyjna", sourceNote: "Tradycyjna melodia w domenie publicznej. TuneUniversal używa uproszczonej wersji do nauki, a nie skopiowanej nowoczesnej partytury.", practiceTips: ["Zachowaj spokojne frazowanie.", "Użyj dźwięku referencyjnego przed rozpoczęciem.", "Spróbuj najpierw wolniejszego BPM."] },
    "twinkle-twinkle-little-star": { origin: "Tradycyjna melodia Ah! vous dirai-je, maman, XVIII wiek", sourceNote: "Tradycyjna melodia w domenie publicznej. TuneUniversal udostępnia uproszczoną wersję do nauki z nutami i akordami dla dzieci.", practiceTips: ["Zacznij od jednego dźwięku na miarę.", "Wyklaszcz rytm przed graniem.", "Używaj C, F i G powoli."] },
    "mary-had-a-little-lamb": { origin: "Tradycyjna melodia dziecięca, XIX wiek", sourceNote: "Melodia dziecięca w domenie publicznej. To uproszczone opracowanie edukacyjne stworzone dla TuneUniversal.", practiceTips: ["Najpierw używaj palców 1, 2 i 3.", "Utrzymuj równy rytm.", "Spróbuj na pianinie, flecie prostym lub ukulele."] },
    "row-row-row-your-boat": { origin: "Kanon tradycyjny, XIX wiek", sourceNote: "Tradycyjny kanon w domenie publicznej. TuneUniversal używa krótkiej uproszczonej wersji do nauki, bez publikowania chronionych wydań.", practiceTips: ["Zaśpiewaj lub zanuć rytm przed graniem.", "Spróbuj jako kanon na dwie osoby.", "Ustaw metronom na wolne tempo."] },
    "london-bridge": { origin: "Angielska tradycyjna piosenka dziecięca", sourceNote: "Tradycyjna melodia w domenie publicznej. Nuty i akordy to uproszczona wersja dydaktyczna TuneUniversal.", practiceTips: ["Graj melodię krótkimi frazami.", "Zacznij od akordów G i D.", "Utrzymuj tempo żywe, ale stabilne."] },
    "hot-cross-buns": { origin: "Angielska tradycyjna melodia dziecięca", sourceNote: "Tradycyjna melodia dziecięca w domenie publicznej. Strona zawiera bardzo krótkie uproszczone opracowanie dla początkujących.", practiceTips: ["Idealna na pierwsze trzy dźwięki.", "Graj powoli i licz na głos.", "Powtarzaj, aż każdy dźwięk będzie czysty."] },
    "baa-baa-black-sheep": { origin: "Tradycyjna melodia rymowanki dziecięcej", sourceNote: "Tradycyjna melodia dziecięca w domenie publicznej. TuneUniversal udostępnia uproszczoną stronę do nauki nut i akordów.", practiceTips: ["Użyj tego samego kształtu melodii co w Twinkle Twinkle.", "Spróbuj najpierw klaskać.", "Zmieniaj akordy powoli."] },
    "old-macdonald-had-a-farm": { origin: "Tradycyjna piosenka dziecięca, XIX wiek", sourceNote: "Tradycyjna melodia dziecięca w domenie publicznej. TuneUniversal używa uproszczonej wersji edukacyjnej z nutami i akordami, bez publikowania chronionych tekstów.", practiceTips: ["Utrzymuj lekki puls 4/4.", "Ćwicz powoli przejście z G na D.", "Użyj Tap BPM, aby znaleźć wygodne tempo."] },
    "skip-to-my-lou": { origin: "Amerykańska tradycyjna piosenka zabawowa, XIX wiek", sourceNote: "Tradycyjna melodia w domenie publicznej. To zwięzłe opracowanie do nauki przygotowane dla początkujących w TuneUniversal.", practiceTips: ["Używaj krótkich, czystych fraz.", "Licz cztery równe miary.", "Spróbuj wyklaskać rytm przed graniem."] },
    "the-muffin-man": { origin: "Angielska tradycyjna piosenka dziecięca, XIX wiek", sourceNote: "Tradycyjna piosenka dziecięca w domenie publicznej. TuneUniversal udostępnia uproszczone nuty i akordy wyłącznie do ćwiczeń.", practiceTips: ["Najpierw graj powoli.", "Utrzymuj równą melodię.", "Przyjmij G i D jako pierwsze cele akordowe."] },
    "yankee-doodle": { origin: "Tradycyjna melodia amerykańska, XVIII wiek", sourceNote: "Tradycyjna melodia w domenie publicznej. Strona zawiera własną uproszczoną wersję do nauki dla początkujących.", practiceTips: ["Czuj dwie miary w takcie.", "Na gitarze używaj kostkowania naprzemiennego.", "Zwolnij metronom, jeśli ósemki przyspieszają."] },
    "jingle-bells": { origin: "James Lord Pierpont, 1857", sourceNote: "Kompozycja w domenie publicznej. TuneUniversal udostępnia uproszczony przewodnik edukacyjny, a nie kopię nowoczesnego wydania.", practiceTips: ["Graj powtarzane dźwięki lekko.", "Utrzymuj jasne, ale kontrolowane tempo.", "Ćwicz powoli przejście z A7 na D."] },
    "silent-night": { origin: "Franz Xaver Gruber i Joseph Mohr, 1818", sourceNote: "Kolęda w domenie publicznej. Nuty i akordy to uproszczone opracowanie edukacyjne przygotowane dla TuneUniversal.", practiceTips: ["Licz trzy delikatne miary.", "Pozwól każdej frazie oddychać.", "Ustaw wolny metronom i nie przyspieszaj pauz."] },
    "auld-lang-syne": { origin: "Tradycyjna melodia szkocka, XVIII wiek", sourceNote: "Tradycyjna melodia w domenie publicznej. TuneUniversal udostępnia krótki uproszczony przewodnik po akordach i nutach.", practiceTips: ["Graj ciepłym legato.", "Zmieniaj akordy bez pośpiechu.", "Transponuj, jeśli tonacja jest niewygodna."] },
    "oh-susanna": { origin: "Stephen Foster, 1848", sourceNote: "Melodia w domenie publicznej. Strona zawiera uproszczoną instrumentalną wersję do nauki i nie reprodukuje chronionych wydań.", practiceTips: ["Utrzymuj sprężysty rytm.", "Zacznij od akordów G i D.", "Użyj akcentu metronomu, aby ustabilizować frazę."] },
    alouette: { origin: "Francusko-kanadyjska piosenka tradycyjna, XIX wiek", sourceNote: "Tradycyjna melodia w domenie publicznej. TuneUniversal używa uproszczonego opracowania edukacyjnego, bez publikowania chronionych tekstów.", practiceTips: ["Używaj krótkich fraz.", "Ćwicz powoli, zanim zwiększysz BPM.", "Spróbuj na gitarze, pianinie lub ukulele."] },
    "when-the-saints-go-marching-in": { origin: "Tradycyjna melodia gospel, początek XX wieku", sourceNote: "Tradycyjna melodia w domenie publicznej w uproszczonym opracowaniu edukacyjnym przygotowanym dla TuneUniversal.", practiceTips: ["Najpierw graj równym pulsem bez swingu.", "Spraw, by melodia śpiewała wyraźnie.", "Dodaj ekspresję dopiero, gdy dźwięki są stabilne."] }
  },
  cs: {
    "ode-to-joy": { origin: "Ludwig van Beethoven, melodie ze Symfonie č. 9, 1824", sourceNote: "Skladba ve veřejném vlastnictví. Jde o zjednodušenou výukovou úpravu TuneUniversal, nikoli o kopii moderního vydání.", practiceTips: ["Před hraním nalaďte na standardní výšku.", "Držte rovnoměrný puls ve 4/4.", "Začněte pomalu a hrajte každou čtvrťovou notu stejně."] },
    "amazing-grace": { origin: "Tradiční chorálová melodie New Britain, 19. století", sourceNote: "Chorálová melodie ve veřejném vlastnictví. Stránka používá vlastního zjednodušeného průvodce akordy a notami, bez reprodukce chráněných vydání.", practiceTips: ["Počítejte tři doby v taktu.", "Nechte dlouhé tóny doznít.", "Zkuste transpozici akordů, pokud je tónina příliš vysoko."] },
    greensleeves: { origin: "Anglická tradiční melodie, 16. století", sourceNote: "Tradiční melodie ve veřejném vlastnictví. Notace je krátká výuková redukce vytvořená pro TuneUniversal.", practiceTips: ["Vnímejte dvě velké doby v 6/8.", "Udržte mollový charakter měkký.", "Cvičte pomalu s akcentem metronomu na první dobu."] },
    "frere-jacques": { origin: "Francouzský tradiční kánon", sourceNote: "Tradiční dětský kánon ve veřejném vlastnictví. TuneUniversal nabízí zjednodušenou studijní verzi s notami a akordy.", practiceTips: ["Použijte ho jako rozehrání.", "Zahrajte melodii jako kánon na dva nástroje.", "Držte uvolněné tempo."] },
    "au-clair-de-la-lune": { origin: "Francouzská tradiční píseň, 18. století", sourceNote: "Tradiční melodie ve veřejném vlastnictví. Jde o kompaktní výukovou úpravu vytvořenou pro tento web.", practiceTips: ["Dobrá první melodie pro začátečníky.", "Používejte akordy v otevřené poloze.", "Hlídejte čisté ukončení tónů."] },
    "sakura-sakura": { origin: "Japonská tradiční melodie", sourceNote: "Tradiční melodie ve veřejném vlastnictví. TuneUniversal používá zjednodušenou studijní verzi, ne okopírovaný moderní notový zápis.", practiceTips: ["Udržte klidné frázování.", "Před začátkem použijte referenční tón.", "Zkuste nejdřív pomalejší BPM."] },
    "twinkle-twinkle-little-star": { origin: "Tradiční melodie Ah! vous dirai-je, maman, 18. století", sourceNote: "Tradiční melodie ve veřejném vlastnictví. TuneUniversal nabízí zjednodušenou studijní verzi s notami a akordy pro děti.", practiceTips: ["Začněte jedním tónem na dobu.", "Před hraním vytleskejte rytmus.", "Používejte C, F a G pomalu."] },
    "mary-had-a-little-lamb": { origin: "Tradiční dětská melodie, 19. století", sourceNote: "Dětská melodie ve veřejném vlastnictví. Jde o zjednodušenou výukovou úpravu vytvořenou pro TuneUniversal.", practiceTips: ["Nejdřív používejte prsty 1, 2 a 3.", "Držte rytmus rovnoměrný.", "Zkuste ji na klavír, zobcovou flétnu nebo ukulele."] },
    "row-row-row-your-boat": { origin: "Tradiční kánon, 19. století", sourceNote: "Tradiční kánon ve veřejném vlastnictví. TuneUniversal používá krátkou zjednodušenou studijní verzi bez publikování chráněných moderních vydání.", practiceTips: ["Před hraním si rytmus zazpívejte nebo zabroukejte.", "Zkuste ji jako kánon ve dvou.", "Nastavte metronom na pomalé tempo."] },
    "london-bridge": { origin: "Anglická tradiční dětská píseň", sourceNote: "Tradiční melodie ve veřejném vlastnictví. Noty a akordy jsou zjednodušená výuková verze TuneUniversal.", practiceTips: ["Hrajte melodii v krátkých frázích.", "Začněte akordy G a D.", "Držte tempo hravé, ale stabilní."] },
    "hot-cross-buns": { origin: "Anglická tradiční dětská melodie", sourceNote: "Tradiční dětská melodie ve veřejném vlastnictví. Stránka používá velmi krátkou zjednodušenou úpravu pro začátečníky.", practiceTips: ["Ideální pro první tři tóny.", "Hrajte pomalu a počítejte nahlas.", "Opakujte, dokud není každý tón čistý."] },
    "baa-baa-black-sheep": { origin: "Tradiční melodie dětské říkanky", sourceNote: "Tradiční dětská melodie ve veřejném vlastnictví. TuneUniversal nabízí zjednodušenou výukovou stránku s notami a akordy.", practiceTips: ["Použijte stejný tvar melodie jako u Twinkle Twinkle.", "Nejdřív zkuste tleskat.", "Měňte akordy pomalu."] },
    "old-macdonald-had-a-farm": { origin: "Tradiční dětská píseň, 19. století", sourceNote: "Tradiční dětská melodie ve veřejném vlastnictví. TuneUniversal používá zjednodušenou výukovou verzi s notami a akordy bez publikování chráněných textů.", practiceTips: ["Držte lehký puls ve 4/4.", "Cvičte pomalu přechod z G na D.", "Pomocí Tap BPM najděte pohodlné tempo."] },
    "skip-to-my-lou": { origin: "Americká tradiční hravá píseň, 19. století", sourceNote: "Tradiční melodie ve veřejném vlastnictví. Jde o kompaktní studijní úpravu vytvořenou pro začátečníky na TuneUniversal.", practiceTips: ["Používejte krátké, čisté fráze.", "Počítejte čtyři stabilní doby.", "Před hraním zkuste rytmus vytleskat."] },
    "the-muffin-man": { origin: "Anglická tradiční dětská píseň, 19. století", sourceNote: "Tradiční dětská píseň ve veřejném vlastnictví. TuneUniversal nabízí zjednodušené noty a akordy pouze pro cvičení.", practiceTips: ["Nejdřív hrajte pomalu.", "Držte melodii rovnoměrnou.", "Vezměte G a D jako první akordové cíle."] },
    "yankee-doodle": { origin: "Tradiční americká melodie, 18. století", sourceNote: "Tradiční melodie ve veřejném vlastnictví. Stránka používá vlastní zjednodušenou studijní verzi pro začátečníky.", practiceTips: ["Vnímejte dvě doby v taktu.", "Na kytaru používejte střídavé trsání.", "Zpomalte metronom, pokud osminy utíkají."] },
    "jingle-bells": { origin: "James Lord Pierpont, 1857", sourceNote: "Skladba ve veřejném vlastnictví. TuneUniversal nabízí zjednodušeného výukového průvodce, ne kopii moderního vydání.", practiceTips: ["Držte opakované tóny lehké.", "Použijte svižné, ale kontrolované tempo.", "Cvičte pomalu přechod z A7 na D."] },
    "silent-night": { origin: "Franz Xaver Gruber a Joseph Mohr, 1818", sourceNote: "Vánoční koleda ve veřejném vlastnictví. Noty a akordy jsou zjednodušená výuková úprava vytvořená pro TuneUniversal.", practiceTips: ["Počítejte tři jemné doby.", "Nechte každou frázi dýchat.", "Použijte pomalý metronom a nespěchejte v pauzách."] },
    "auld-lang-syne": { origin: "Tradiční skotská melodie, 18. století", sourceNote: "Tradiční melodie ve veřejném vlastnictví. TuneUniversal nabízí krátkého zjednodušeného průvodce akordy a notami.", practiceTips: ["Hrajte s teplým legatem.", "Měňte akordy bez spěchu.", "Transponujte, pokud je tónina nepohodlná."] },
    "oh-susanna": { origin: "Stephen Foster, 1848", sourceNote: "Melodie ve veřejném vlastnictví. Stránka obsahuje zjednodušenou instrumentální studijní verzi a nereprodukuje chráněná vydání.", practiceTips: ["Držte pružný rytmus.", "Začněte akordy G a D.", "Použijte akcent metronomu ke stabilizaci fráze."] },
    alouette: { origin: "Francouzsko-kanadská tradiční píseň, 19. století", sourceNote: "Tradiční melodie ve veřejném vlastnictví. TuneUniversal používá zjednodušenou výukovou úpravu bez publikování chráněných textů.", practiceTips: ["Používejte krátké fráze.", "Cvičte pomalu, než zvýšíte BPM.", "Zkuste ji na kytaru, klavír nebo ukulele."] },
    "when-the-saints-go-marching-in": { origin: "Tradiční gospelová melodie, začátek 20. století", sourceNote: "Tradiční melodie ve veřejném vlastnictví ve zjednodušené výukové úpravě vytvořené pro TuneUniversal.", practiceTips: ["Nejdřív hrajte stabilním pulsem bez swingu.", "Nechte melodii jasně zpívat.", "Výraz přidejte až po ustálení tónů."] }
  },
  nl: {
    "ode-to-joy": { origin: "Ludwig van Beethoven, melodie uit Symfonie nr. 9, 1824", sourceNote: "Compositie in het publieke domein. Dit is een vereenvoudigd educatief arrangement van TuneUniversal, niet overgenomen uit een moderne uitgave.", practiceTips: ["Stem op standaardtoonhoogte voordat je begint.", "Houd een gelijkmatige 4/4-puls aan.", "Begin langzaam en houd elke kwartnoot gelijk."] },
    "amazing-grace": { origin: "Traditionele hymnemelodie New Britain, 19e eeuw", sourceNote: "Hymnemelodie in het publieke domein. Deze pagina gebruikt een eigen vereenvoudigde akkoord- en notengids zonder beschermde uitgaven te reproduceren.", practiceTips: ["Tel drie tellen per maat.", "Laat lange noten doorklinken.", "Probeer de akkoordtransponeerder als de toonsoort te hoog ligt."] },
    greensleeves: { origin: "Engelse traditionele melodie, 16e eeuw", sourceNote: "Traditionele melodie in het publieke domein. De notatie hier is een korte educatieve reductie gemaakt voor TuneUniversal.", practiceTips: ["Voel twee grote tellen in 6/8.", "Houd het mineurkarakter zacht.", "Oefen langzaam met het metronoomaccent op tel een."] },
    "frere-jacques": { origin: "Franse traditionele canon", sourceNote: "Traditionele kindercanon in het publieke domein. TuneUniversal biedt een vereenvoudigde studieversie met noten en akkoorden.", practiceTips: ["Gebruik het als warming-up.", "Speel de melodie als canon met twee instrumenten.", "Houd het tempo ontspannen."] },
    "au-clair-de-la-lune": { origin: "Frans traditioneel lied, 18e eeuw", sourceNote: "Traditionele melodie in het publieke domein. Dit is een compact educatief arrangement voor de site.", practiceTips: ["Goede eerste melodie voor beginners.", "Gebruik akkoorden in open positie.", "Let op schone noteneindes."] },
    "sakura-sakura": { origin: "Japanse traditionele melodie", sourceNote: "Traditionele melodie in het publieke domein. TuneUniversal gebruikt een vereenvoudigde studieversie, geen gekopieerde moderne partituur.", practiceTips: ["Houd de frasering rustig.", "Gebruik de referentietoon voordat je begint.", "Probeer eerst een lagere BPM."] },
    "twinkle-twinkle-little-star": { origin: "Traditionele melodie Ah! vous dirai-je, maman, 18e eeuw", sourceNote: "Traditionele melodie in het publieke domein. TuneUniversal biedt een vereenvoudigde studieversie met noten en akkoorden voor kinderen.", practiceTips: ["Begin met een noot per tel.", "Klap het ritme voordat je speelt.", "Gebruik C, F en G langzaam."] },
    "mary-had-a-little-lamb": { origin: "Traditionele kindermelodie, 19e eeuw", sourceNote: "Kindermelodie in het publieke domein. Dit is een vereenvoudigd educatief arrangement gemaakt voor TuneUniversal.", practiceTips: ["Gebruik eerst vingers 1, 2 en 3.", "Houd het ritme gelijkmatig.", "Probeer het op piano, blokfluit of ukelele."] },
    "row-row-row-your-boat": { origin: "Traditionele canon, 19e eeuw", sourceNote: "Traditionele canon in het publieke domein. TuneUniversal gebruikt een korte vereenvoudigde studieversie zonder beschermde moderne uitgaven te publiceren.", practiceTips: ["Zing of neurie het ritme voordat je speelt.", "Probeer het als canon met twee spelers.", "Gebruik de metronoom op lage snelheid."] },
    "london-bridge": { origin: "Engels traditioneel kinderlied", sourceNote: "Traditionele melodie in het publieke domein. De noten en akkoorden zijn een vereenvoudigde lesversie van TuneUniversal.", practiceTips: ["Speel de melodie in korte frases.", "Gebruik eerst de akkoorden G en D.", "Houd het tempo speels maar stabiel."] },
    "hot-cross-buns": { origin: "Engels traditioneel kinderdeuntje", sourceNote: "Traditioneel kinderdeuntje in het publieke domein. Deze pagina gebruikt een heel kort vereenvoudigd arrangement voor beginners.", practiceTips: ["Perfect voor de eerste drie noten.", "Speel langzaam en tel hardop.", "Herhaal tot elke noot schoon klinkt."] },
    "baa-baa-black-sheep": { origin: "Traditionele melodie van een kinderrijmpje", sourceNote: "Traditionele kindermelodie in het publieke domein. TuneUniversal biedt een vereenvoudigde leerpagina met noten en akkoorden.", practiceTips: ["Gebruik dezelfde melodievorm als Twinkle Twinkle.", "Probeer eerst te klappen.", "Houd de akkoordwisselingen langzaam."] },
    "old-macdonald-had-a-farm": { origin: "Traditioneel kinderlied, 19e eeuw", sourceNote: "Traditionele kindermelodie in het publieke domein. TuneUniversal gebruikt een vereenvoudigde educatieve versie met noten en akkoorden zonder beschermde teksten te publiceren.", practiceTips: ["Houd een lichte 4/4-puls aan.", "Oefen de wissel van G naar D langzaam.", "Gebruik Tap BPM om een prettige snelheid te vinden."] },
    "skip-to-my-lou": { origin: "Amerikaans traditioneel speelliedje, 19e eeuw", sourceNote: "Traditioneel deuntje in het publieke domein. Dit is een compact studiearrangement gemaakt voor beginners van TuneUniversal.", practiceTips: ["Gebruik korte, schone frases.", "Tel vier gelijkmatige tellen.", "Klap het ritme voordat je speelt."] },
    "the-muffin-man": { origin: "Engels traditioneel kinderlied, 19e eeuw", sourceNote: "Traditioneel kinderlied in het publieke domein. TuneUniversal biedt vereenvoudigde noten en akkoorden, uitsluitend om te oefenen.", practiceTips: ["Speel eerst langzaam.", "Houd de melodie gelijkmatig.", "Neem G en D als eerste akkoorddoelen."] },
    "yankee-doodle": { origin: "Traditionele Amerikaanse melodie, 18e eeuw", sourceNote: "Traditionele melodie in het publieke domein. Deze pagina gebruikt een eigen vereenvoudigde studieversie voor beginners.", practiceTips: ["Voel twee tellen per maat.", "Gebruik afwisselende slag op gitaar.", "Zet de metronoom lager als de achtsten gaan rennen."] },
    "jingle-bells": { origin: "James Lord Pierpont, 1857", sourceNote: "Compositie in het publieke domein. TuneUniversal biedt een vereenvoudigde educatieve gids, geen kopie van een moderne uitgave.", practiceTips: ["Houd de herhaalde noten licht.", "Gebruik een helder maar beheerst tempo.", "Oefen de wissel van A7 naar D langzaam."] },
    "silent-night": { origin: "Franz Xaver Gruber en Joseph Mohr, 1818", sourceNote: "Kerstlied in het publieke domein. De noten en akkoorden hier zijn een vereenvoudigd educatief arrangement gemaakt voor TuneUniversal.", practiceTips: ["Tel drie zachte tellen.", "Laat elke frase ademen.", "Gebruik een langzame metronoom en haast de rusten niet."] },
    "auld-lang-syne": { origin: "Traditionele Schotse melodie, 18e eeuw", sourceNote: "Traditionele melodie in het publieke domein. TuneUniversal biedt een korte vereenvoudigde akkoord- en notengids.", practiceTips: ["Speel met een warm legatogevoel.", "Houd de akkoordwisselingen ontspannen.", "Transponeer als de toonsoort ongemakkelijk ligt."] },
    "oh-susanna": { origin: "Stephen Foster, 1848", sourceNote: "Melodie in het publieke domein. Deze pagina bevat een vereenvoudigde instrumentale studieversie en reproduceert geen beschermde uitgaven.", practiceTips: ["Houd het ritme verend.", "Begin met de akkoorden G en D.", "Gebruik het metronoomaccent om de frase te stabiliseren."] },
    alouette: { origin: "Frans-Canadees traditioneel lied, 19e eeuw", sourceNote: "Traditionele melodie in het publieke domein. TuneUniversal gebruikt een vereenvoudigd educatief arrangement zonder beschermde teksten te publiceren.", practiceTips: ["Gebruik kleine frases.", "Oefen langzaam voordat je de BPM verhoogt.", "Probeer het met gitaar, piano of ukelele."] },
    "when-the-saints-go-marching-in": { origin: "Traditionele gospelmelodie, begin 20e eeuw", sourceNote: "Traditionele melodie in het publieke domein in een vereenvoudigd educatief arrangement gemaakt voor TuneUniversal.", practiceTips: ["Gebruik eerst een gelijkmatige puls zonder swing.", "Laat de melodie duidelijk zingen.", "Voeg pas expressie toe als de noten stabiel zijn."] }
  },
  sv: {
    "ode-to-joy": { origin: "Ludwig van Beethoven, melodi ur Symfoni nr 9, 1824", sourceNote: "Komposition i public domain. Detta är ett förenklat pedagogiskt arrangemang från TuneUniversal, inte kopierat från en modern utgåva.", practiceTips: ["Stäm till standardtonhöjd innan du spelar.", "Håll en jämn 4/4-puls.", "Börja långsamt och håll varje fjärdedelsnot jämn."] },
    "amazing-grace": { origin: "Traditionell psalmmelodi New Britain, 1800-talet", sourceNote: "Psalmmelodi i public domain. Sidan använder en egen förenklad ackord- och notguide utan att återge skyddade utgåvor.", practiceTips: ["Räkna tre slag per takt.", "Låt långa toner klinga ut.", "Prova ackordtransponeraren om tonarten ligger för högt."] },
    greensleeves: { origin: "Engelsk traditionell melodi, 1500-talet", sourceNote: "Traditionell melodi i public domain. Notationen här är en kort pedagogisk reduktion skapad för TuneUniversal.", practiceTips: ["Känn två stora slag i 6/8.", "Håll mollkaraktären mjuk.", "Öva långsamt med metronomens accent på slag ett."] },
    "frere-jacques": { origin: "Fransk traditionell kanon", sourceNote: "Traditionell barnkanon i public domain. TuneUniversal erbjuder en förenklad studieversion med noter och ackord.", practiceTips: ["Använd den som uppvärmning.", "Spela melodin som kanon med två instrument.", "Håll tempot avslappnat."] },
    "au-clair-de-la-lune": { origin: "Fransk traditionell sång, 1700-talet", sourceNote: "Traditionell melodi i public domain. Detta är ett kompakt pedagogiskt arrangemang gjort för sajten.", practiceTips: ["Bra första melodi för nybörjare.", "Använd ackord i öppet läge.", "Lyssna efter rena tonavslut."] },
    "sakura-sakura": { origin: "Japansk traditionell melodi", sourceNote: "Traditionell melodi i public domain. TuneUniversal använder en förenklad studieversion, inte en kopierad modern notbild.", practiceTips: ["Håll fraseringen lugn.", "Använd referenstonen innan du börjar.", "Prova ett långsammare BPM först."] },
    "twinkle-twinkle-little-star": { origin: "Traditionell melodi Ah! vous dirai-je, maman, 1700-talet", sourceNote: "Traditionell melodi i public domain. TuneUniversal erbjuder en förenklad studieversion med noter och ackord för barn.", practiceTips: ["Börja med en ton per slag.", "Klappa rytmen innan du spelar.", "Använd C, F och G långsamt."] },
    "mary-had-a-little-lamb": { origin: "Traditionell barnmelodi, 1800-talet", sourceNote: "Barnmelodi i public domain. Detta är ett förenklat pedagogiskt arrangemang skapat för TuneUniversal.", practiceTips: ["Använd fingrarna 1, 2 och 3 först.", "Håll rytmen jämn.", "Prova den på piano, blockflöjt eller ukulele."] },
    "row-row-row-your-boat": { origin: "Traditionell kanon, 1800-talet", sourceNote: "Traditionell kanon i public domain. TuneUniversal använder en kort förenklad studieversion utan att publicera skyddade moderna utgåvor.", practiceTips: ["Sjung eller nynna rytmen innan du spelar.", "Prova den som kanon med två spelare.", "Använd metronomen i långsamt tempo."] },
    "london-bridge": { origin: "Engelsk traditionell barnsång", sourceNote: "Traditionell melodi i public domain. Noterna och ackorden är en förenklad undervisningsversion från TuneUniversal.", practiceTips: ["Spela melodin i korta fraser.", "Använd ackorden G och D först.", "Håll tempot lekfullt men stadigt."] },
    "hot-cross-buns": { origin: "Engelsk traditionell barnvisa", sourceNote: "Traditionell barnvisa i public domain. Sidan använder ett mycket kort förenklat arrangemang för nybörjare.", practiceTips: ["Perfekt för de tre första tonerna.", "Spela långsamt och räkna högt.", "Upprepa tills varje ton är ren."] },
    "baa-baa-black-sheep": { origin: "Traditionell barnramsmelodi", sourceNote: "Traditionell barnmelodi i public domain. TuneUniversal erbjuder en förenklad lärosida med noter och ackord.", practiceTips: ["Använd samma melodiform som Twinkle Twinkle.", "Prova att klappa först.", "Håll ackordbytena långsamma."] },
    "old-macdonald-had-a-farm": { origin: "Traditionell barnsång, 1800-talet", sourceNote: "Traditionell barnmelodi i public domain. TuneUniversal använder en förenklad pedagogisk version med noter och ackord utan att publicera skyddade texter.", practiceTips: ["Håll en lätt 4/4-puls.", "Öva bytet från G till D långsamt.", "Använd Tap BPM för att hitta ett bekvämt tempo."] },
    "skip-to-my-lou": { origin: "Amerikansk traditionell leksång, 1800-talet", sourceNote: "Traditionell melodi i public domain. Detta är ett kompakt studiearrangemang skapat för nybörjare på TuneUniversal.", practiceTips: ["Använd korta, rena fraser.", "Räkna fyra stadiga slag.", "Prova att klappa rytmen innan du spelar."] },
    "the-muffin-man": { origin: "Engelsk traditionell barnsång, 1800-talet", sourceNote: "Traditionell barnsång i public domain. TuneUniversal erbjuder förenklade noter och ackord enbart för övning.", practiceTips: ["Spela långsamt först.", "Håll melodin jämn.", "Ta G och D som första ackordmål."] },
    "yankee-doodle": { origin: "Traditionell amerikansk melodi, 1700-talet", sourceNote: "Traditionell melodi i public domain. Sidan använder en egen förenklad studieversion för nybörjare.", practiceTips: ["Känn två slag per takt.", "Använd växelanslag på gitarr.", "Sänk metronomen om åttondelarna rusar."] },
    "jingle-bells": { origin: "James Lord Pierpont, 1857", sourceNote: "Komposition i public domain. TuneUniversal erbjuder en förenklad pedagogisk guide, inte en kopia av en modern utgåva.", practiceTips: ["Håll de upprepade tonerna lätta.", "Använd ett ljust men kontrollerat tempo.", "Öva bytet från A7 till D långsamt."] },
    "silent-night": { origin: "Franz Xaver Gruber och Joseph Mohr, 1818", sourceNote: "Julsång i public domain. Noterna och ackorden här är ett förenklat pedagogiskt arrangemang gjort för TuneUniversal.", practiceTips: ["Räkna tre mjuka slag.", "Låt varje fras andas.", "Använd en långsam metronom och forcera inte pauserna."] },
    "auld-lang-syne": { origin: "Traditionell skotsk melodi, 1700-talet", sourceNote: "Traditionell melodi i public domain. TuneUniversal erbjuder en kort förenklad ackord- och notguide.", practiceTips: ["Spela med varm legatokänsla.", "Håll ackordbytena avspända.", "Transponera om tonarten känns obekväm."] },
    "oh-susanna": { origin: "Stephen Foster, 1848", sourceNote: "Melodi i public domain. Sidan innehåller en förenklad instrumental studieversion och återger inte skyddade utgåvor.", practiceTips: ["Håll rytmen studsande.", "Börja med ackorden G och D.", "Använd metronomens accent för att stabilisera frasen."] },
    alouette: { origin: "Fransk-kanadensisk traditionell sång, 1800-talet", sourceNote: "Traditionell melodi i public domain. TuneUniversal använder ett förenklat pedagogiskt arrangemang utan att publicera skyddade texter.", practiceTips: ["Använd små fraser.", "Öva långsamt innan du ökar BPM.", "Prova den med gitarr, piano eller ukulele."] },
    "when-the-saints-go-marching-in": { origin: "Traditionell gospelmelodi, tidigt 1900-tal", sourceNote: "Traditionell melodi i public domain i ett förenklat pedagogiskt arrangemang skapat för TuneUniversal.", practiceTips: ["Använd en stadig puls utan swing först.", "Låt melodin sjunga tydligt.", "Lägg till uttryck först när tonerna sitter."] }
  },
  no: {
    "ode-to-joy": { origin: "Ludwig van Beethoven, melodi fra Symfoni nr. 9, 1824", sourceNote: "Komposisjon i det fri. Dette er et forenklet pedagogisk arrangement fra TuneUniversal, ikke kopiert fra en moderne utgave.", practiceTips: ["Stem til standard tonehøyde før du spiller.", "Hold en jevn 4/4-puls.", "Start langsomt og hold hver fjerdedelsnote jevn."] },
    "amazing-grace": { origin: "Tradisjonell salmemelodi New Britain, 1800-tallet", sourceNote: "Salmemelodi i det fri. Siden bruker en egen forenklet akkord- og noteguide uten å gjengi beskyttede utgaver.", practiceTips: ["Tell tre slag per takt.", "La lange toner klinge ut.", "Prøv akkordtransponereren hvis tonearten ligger for høyt."] },
    greensleeves: { origin: "Engelsk tradisjonell melodi, 1500-tallet", sourceNote: "Tradisjonell melodi i det fri. Notasjonen her er en kort pedagogisk forkortelse laget for TuneUniversal.", practiceTips: ["Kjenn to store slag i 6/8.", "Hold mollpreget mykt.", "Øv langsomt med metronomaksent på slag én."] },
    "frere-jacques": { origin: "Fransk tradisjonell kanon", sourceNote: "Tradisjonell barnekanon i det fri. TuneUniversal tilbyr en forenklet studieversjon med noter og akkorder.", practiceTips: ["Bruk den som oppvarming.", "Spill melodien som kanon med to instrumenter.", "Hold tempoet avslappet."] },
    "au-clair-de-la-lune": { origin: "Fransk tradisjonell sang, 1700-tallet", sourceNote: "Tradisjonell melodi i det fri. Dette er et kompakt pedagogisk arrangement laget for nettstedet.", practiceTips: ["God første melodi for nybegynnere.", "Bruk akkorder i åpen posisjon.", "Lytt etter rene noteavslutninger."] },
    "sakura-sakura": { origin: "Japansk tradisjonell melodi", sourceNote: "Tradisjonell melodi i det fri. TuneUniversal bruker en forenklet studieversjon, ikke et kopiert moderne noteark.", practiceTips: ["Hold fraseringen rolig.", "Bruk referansetonen før du begynner.", "Prøv et lavere BPM først."] },
    "twinkle-twinkle-little-star": { origin: "Tradisjonell melodi Ah! vous dirai-je, maman, 1700-tallet", sourceNote: "Tradisjonell melodi i det fri. TuneUniversal tilbyr en forenklet studieversjon med noter og akkorder for barn.", practiceTips: ["Start med én tone per slag.", "Klapp rytmen før du spiller.", "Bruk C, F og G langsomt."] },
    "mary-had-a-little-lamb": { origin: "Tradisjonell barnemelodi, 1800-tallet", sourceNote: "Barnemelodi i det fri. Dette er et forenklet pedagogisk arrangement laget for TuneUniversal.", practiceTips: ["Bruk fingrene 1, 2 og 3 først.", "Hold rytmen jevn.", "Prøv den på piano, blokkfløyte eller ukulele."] },
    "row-row-row-your-boat": { origin: "Tradisjonell kanon, 1800-tallet", sourceNote: "Tradisjonell kanon i det fri. TuneUniversal bruker en kort forenklet studieversjon uten å publisere beskyttede moderne utgaver.", practiceTips: ["Syng eller nynn rytmen før du spiller.", "Prøv den som kanon med to spillere.", "Bruk metronomen i lavt tempo."] },
    "london-bridge": { origin: "Engelsk tradisjonell barnesang", sourceNote: "Tradisjonell melodi i det fri. Notene og akkordene er en forenklet undervisningsversjon fra TuneUniversal.", practiceTips: ["Spill melodien i korte fraser.", "Bruk akkordene G og D først.", "Hold tempoet leken, men stødig."] },
    "hot-cross-buns": { origin: "Engelsk tradisjonell barnemelodi", sourceNote: "Tradisjonell barnemelodi i det fri. Siden bruker et svært kort forenklet arrangement for nybegynnere.", practiceTips: ["Perfekt for de tre første tonene.", "Spill langsomt og tell høyt.", "Gjenta til hver tone er ren."] },
    "baa-baa-black-sheep": { origin: "Tradisjonell barneregle-melodi", sourceNote: "Tradisjonell barnemelodi i det fri. TuneUniversal tilbyr en forenklet læringsside med noter og akkorder.", practiceTips: ["Bruk samme melodiform som Twinkle Twinkle.", "Prøv å klappe først.", "Hold akkordskiftene langsomme."] },
    "old-macdonald-had-a-farm": { origin: "Tradisjonell barnesang, 1800-tallet", sourceNote: "Tradisjonell barnemelodi i det fri. TuneUniversal bruker en forenklet pedagogisk versjon med noter og akkorder uten å publisere beskyttede tekster.", practiceTips: ["Hold en lett 4/4-puls.", "Øv skiftet fra G til D langsomt.", "Bruk Tap BPM for å finne et behagelig tempo."] },
    "skip-to-my-lou": { origin: "Amerikansk tradisjonell lekesang, 1800-tallet", sourceNote: "Tradisjonell melodi i det fri. Dette er et kompakt studiearrangement laget for nybegynnere på TuneUniversal.", practiceTips: ["Bruk korte, rene fraser.", "Tell fire stødige slag.", "Prøv å klappe rytmen før du spiller."] },
    "the-muffin-man": { origin: "Engelsk tradisjonell barnesang, 1800-tallet", sourceNote: "Tradisjonell barnesang i det fri. TuneUniversal tilbyr forenklede noter og akkorder kun til øving.", practiceTips: ["Spill langsomt først.", "Hold melodien jevn.", "Ta G og D som første akkordmål."] },
    "yankee-doodle": { origin: "Tradisjonell amerikansk melodi, 1700-tallet", sourceNote: "Tradisjonell melodi i det fri. Siden bruker en egen forenklet studieversjon for nybegynnere.", practiceTips: ["Kjenn to slag per takt.", "Bruk vekselanslag på gitar.", "Senk metronomen hvis åttendelene løper."] },
    "jingle-bells": { origin: "James Lord Pierpont, 1857", sourceNote: "Komposisjon i det fri. TuneUniversal tilbyr en forenklet pedagogisk guide, ikke en kopi av en moderne utgave.", practiceTips: ["Hold de gjentatte tonene lette.", "Bruk et lyst, men kontrollert tempo.", "Øv skiftet fra A7 til D langsomt."] },
    "silent-night": { origin: "Franz Xaver Gruber og Joseph Mohr, 1818", sourceNote: "Julesang i det fri. Notene og akkordene her er et forenklet pedagogisk arrangement laget for TuneUniversal.", practiceTips: ["Tell tre myke slag.", "La hver frase puste.", "Bruk en langsom metronom og ikke forhast pausene."] },
    "auld-lang-syne": { origin: "Tradisjonell skotsk melodi, 1700-tallet", sourceNote: "Tradisjonell melodi i det fri. TuneUniversal tilbyr en kort forenklet akkord- og noteguide.", practiceTips: ["Spill med varm legatofølelse.", "Hold akkordskiftene avslappede.", "Transponer hvis tonearten er ubehagelig."] },
    "oh-susanna": { origin: "Stephen Foster, 1848", sourceNote: "Melodi i det fri. Siden inneholder en forenklet instrumental studieversjon og gjengir ikke beskyttede utgaver.", practiceTips: ["Hold rytmen sprettende.", "Start med akkordene G og D.", "Bruk metronomaksenten til å stabilisere frasen."] },
    alouette: { origin: "Fransk-kanadisk tradisjonell sang, 1800-tallet", sourceNote: "Tradisjonell melodi i det fri. TuneUniversal bruker et forenklet pedagogisk arrangement uten å publisere beskyttede tekster.", practiceTips: ["Bruk små fraser.", "Øv langsomt før du øker BPM.", "Prøv den med gitar, piano eller ukulele."] },
    "when-the-saints-go-marching-in": { origin: "Tradisjonell gospelmelodi, tidlig 1900-tall", sourceNote: "Tradisjonell melodi i det fri i et forenklet pedagogisk arrangement laget for TuneUniversal.", practiceTips: ["Bruk en stødig puls uten swing først.", "La melodien synge tydelig.", "Legg til uttrykk først når tonene sitter."] }
  },
  it: {
...
export function getLocalizedSong(slug: PublicDomainSongSlug, locale: Locale): PublicDomainSong {
  ...
  const overrides = songLocalizations[locale]?.[slug] ?? songLocalizations[getContentLocale(locale)]?.[slug];
  if (!overrides) {
    return base;
  }
  return {
