...
/**
 * `instrumentLabels` only covers the 11 base locales, so the extended locales rendered
 * English instrument names inside otherwise translated titles ("Online ladička na Harp").
 * The noun is the keyword these tuner pages rank for, so it has to be native too.
 */
const extendedInstrumentLabels: Partial<Record<Locale, Record<Instrument, string>>> = {
  nl: {
    "7-string-guitar": "7-snarige gitaar",
    "8-string-guitar": "8-snarige gitaar",
    "12-string-guitar": "12-snarige gitaar",
    banjo: "Banjo",
    bass: "Basgitaar",
    cello: "Cello",
    cimbalom: "Cimbalom",
  ...
  pl: {
    "7-string-guitar": "Gitara 7-strunowa",
    "8-string-guitar": "Gitara 8-strunowa",
    "12-string-guitar": "Gitara 12-strunowa",
    banjo: "Banjo",
    bass: "Gitara basowa",
    cello: "Wiolonczela",
    cimbalom: "Cymbały",
  ...
  tr: {
    "7-string-guitar": "7 telli gitar",
    "8-string-guitar": "8 telli gitar",
    "12-string-guitar": "12 telli gitar",
    banjo: "Banjo",
    bass: "Bas gitar",
    cello: "Çello",
    cimbalom: "Cimbalom",
  ...
  cs: {
    "7-string-guitar": "Sedmistrunná kytara",
    "8-string-guitar": "Osmistrunná kytara",
    "12-string-guitar": "Dvanáctistrunná kytara",
    banjo: "Banjo",
    bass: "Baskytara",
    cello: "Violoncello",
    cimbalom: "Cimbál",
  ...
  sv: {
    "7-string-guitar": "7-strängad gitarr",
    "8-string-guitar": "8-strängad gitarr",
    "12-string-guitar": "12-strängad gitarr",
    banjo: "Banjo",
    bass: "Basgitarr",
    cello: "Cello",
    cimbalom: "Cimbalom",
  ...
  no: {
    ...
    "12-string-guitar": "12-strengs gitar",
    banjo: "Banjo",
    bass: "Bassgitar",
    cello: "Cello",
    cimbalom: "Cimbalom",
  ...
  hi: {
    "7-string-guitar": "7-तार गिटार",
    "8-string-guitar": "8-तार गिटार",
    "12-string-guitar": "12-तार गिटार",
    banjo: "बैंजो",
    bass: "बास गिटार",
    cello: "चेलो",
    cimbalom: "सिंबलोम",
    ...
    ukulele: "युकुलेले",
    viola: "वायोला",
    "viola-da-gamba": "वायोला दा गाम्बा",
    violin: "वायलिन",
    yangqin: "यांगकिन"
  }
};
...
export function getInstrumentLabel(instrument: Instrument, locale: Locale) {
  const extended = extendedInstrumentLabels[locale]?.[instrument];
