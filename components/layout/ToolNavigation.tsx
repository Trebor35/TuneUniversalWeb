      ...
      {tools.map((slug) => (
        ...
        >
          ...
          <span className="min-w-0">
            <span className="block break-words font-semibold">{dictionary.tools[slug].title}</span>
            <span className="mt-1 block break-words text-sm leading-6 text-ink/68">{dictionary.tools[slug].description}</span>
          </span>
        </Link>
      ))}
    </nav>
