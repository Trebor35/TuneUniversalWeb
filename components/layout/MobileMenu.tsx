...
export function MobileMenu({ groups, label }: { groups: MobileNavGroup[]; label: string }) {
  ...
  return (
    <div className="relative lg:hidden">
      ...
      {open ? (
        <div className="absolute left-0 top-12 z-50 w-[calc(100vw-2rem)] max-w-sm max-h-[calc(100vh-5.5rem)] overflow-y-auto rounded-lg border border-line bg-white p-4 text-left shadow-soft">
