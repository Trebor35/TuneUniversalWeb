...
> = {
  ...
  de: { accentFirstBeat: "Akzent auf erster Zählzeit", apply: "Laden", beat: "Schlag", denominator: "Nenner", haptics: "Vibration/Blitz", headphones: "Kopfhörer", noPresets: "Keine Presets gespeichert", numerator: "Zähler", output: "Ausgabe", practiceAdvance: "BPM ändern", practiceAfterBars: "Nach vollen Takten", practiceAfterTime: "Nach Zeit", practiceBars: "Takte", practiceCycle: "Uebungszyklus", practiceEvery: "Alle", practiceIncrement: "Inkrement", practiceSeconds: "Sekunden", practiceStart: "Start-BPM", practiceTarget: "Ziel-BPM", presets: "Preset-Speicher", savePreset: "Preset speichern", silentModeNote: "Auf dem iPhone kann der Stummschalter den Browser-Ton blockieren: Stummschaltung deaktivieren oder Kopfhörer verwenden. Der Beat-Blitz bleibt aktiv.", speaker: "Lautsprecher", subdivision: "Rhythmische Unterteilung", tapHint: "Tap Tempo" },
